...
- Correct `CITATION.cff` reference metadata for the iconicity ratings data so CFF validation passes.

## [1.0.7] - 2026-07-05

### Changed

- Prepare release metadata for v1.0.7 after removing the Zenodo metadata file.
...
[1.0.8]: https://github.com/ChildConicFoundation/ChildConicity/releases/tag/v1.0.8
[1.0.7]: https://github.com/ChildConicFoundation/ChildConicity/releases/tag/v1.0.7
