...
[![DOI](https://img.shields.io/badge/DOI-10.5281%2Fzenodo.21199304-1682D4)](https://doi.org/10.5281/zenodo.21199304)
...
@software{childconicity2026,
  ...
  note         = {Release v1.0.8. Alias en GitHub: Errowdrigorena},
}
```
...
Rodriguez Iglesias, I., & ChildConic Foundation. (2026). *ChildConicity* (Versión 1.0.8) [Software informático]. GitHub. https://github.com/ChildConicFoundation/ChildConicity
