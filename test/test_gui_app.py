...
def test_token_plot_directories_are_derived_from_output_dir():
    plots_dir, distribution_dir = _token_plot_directories("salida_tokens")

    assert plots_dir == "salida_tokens/iconic_vs_noniconic"
    assert distribution_dir == "salida_tokens/pruebas"
...
def test_token_plot_directories_fall_back_to_default_output_dir():
    ...
    assert distribution_dir == "quarterly_valid_words/pruebas"
